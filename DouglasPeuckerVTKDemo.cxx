...
int main(int argc, char *argv[])
{
  ...
  std::cout << "There are " << path->GetNumberOfPoints() << " points in the input path." << std::endl;
  ...
  std::cout << "There are " << simplifiedPath->GetNumberOfPoints() << " points on the simplified path." << std::endl;
...
0.378232, 0.418716};
  ...
  for(unsigned int i = 0; i < vtkpoints->GetNumberOfPoints(); i++)
    {
